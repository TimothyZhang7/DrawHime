...
export function App() {
  ...
  return <div className="desktop-shell" data-environment-status={bootstrap.environment.status} data-inference-ready={bootstrap.environment.capabilities.inference} data-training-ready={bootstrap.environment.capabilities.training}>
    ...
    <main className="desktop-main">
      ...
      <div hidden={page !== "generate"}><GenerationPage models={models} loras={loras} jobs={jobs} inferenceReady={bootstrap.environment.capabilities.inference} defaultPrivacy={bootstrap.settings.defaultPrivacy} onCreated={jobCreated} onError={setMessage} /></div>
