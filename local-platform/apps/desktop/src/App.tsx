...
const navigation = [
  ...
  { id: "updates" as const, label: "软件更新", Icon: RefreshCw },
...
function pageTitle(page: DesktopPage): string { return { generate: "本地生成", jobs: "任务记录", models: "本地模型", loras: "LoRA 仓库", training: "LoRA 训练", overview: "本机概览", environment: "环境检测", resources: "资源安装", updates: "软件更新", sync: "图库同步", account: "账号连接", settings: "本地设置" }[page]; }
